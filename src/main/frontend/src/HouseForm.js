    ...
    return (
        <Form noValidate validated={validated} ref={reference} encType="multipart/form-data">
            ...
            <Form.Group controlId="formFileMultiple" className="mb-3">
                ...
                <Form.Control type="file" multiple name="fileImage" ref={imagesRef} accept="image/png, image/jpeg"/>
                <p id="noImages" style={{color:"#dc3545", fontSize: "0.875em", marginLeft:"34%", display:"none"}}>Molimo Vas postavite bar tri fotografije.</p>
            </Form.Group>
            </Form>
    );
}
