...
export function Calendar({adventure, reservable}){
    ...
    return (<div id="calendar" className="d-flex justify-content-center">
        <div className="ms-5 me-3 mt-4" style={{width: "65%"}}>
            <FullCalendar
                plugins={[dayGridPlugin, interactionPlugin]}
                initialView="dayGridMonth"
                events={events}
                eventColor={"rgb(255,96,96)"}
