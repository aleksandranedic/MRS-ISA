package com.project.team9.security.config;

import com.project.team9.security.auth.RestAuthenticationEntryPoint;
import com.project.team9.security.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public WebSecurityConfig(PasswordEncoder passwordEncoder, UserServiceSecurity userServiceSecurity, RestAuthenticationEntryPoint restAuthenticationEntryPoint) {
...
//                .antMatchers("/client/**").permitAll()
                ...
                .addFilterBefore(new TokenAuthenticationFilter(tokenUtils, userServiceSecurity), BasicAuthenticationFilter.class);
